    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h5 class="box-title">Bank to Cash Transaction</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('BankToCash.Store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row">
                        <!-- Payment Method ID -->
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group mb-4">
                                <label for="reference">Check Number</label>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group mb-4">
                                <label for="amount">Withdraw Amount<span style="color: red;">*</span></label>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group mb-4">
                                <label for="image">Check Image</label>
