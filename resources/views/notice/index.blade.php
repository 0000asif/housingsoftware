    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h5 class="box-title">All Notice List</h5>
                <a href="{{ route('notice.create') }}" class="btn btn-success btn-sm">Add new</a>
            </div>
            <div class="card-body">
                <br>
                        ...
                        <tbody>
                            @foreach ($notices as $key => $value)
                                <tr>
                                    ...
                                    <td>{{ $value->file ?? 'N/A' }}
                                        <a href="{{ asset('public/image/notice/' . $value->file) }}" download=""
