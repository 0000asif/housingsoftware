    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h5 class="box-title">All Unit/Room List</h5>
                <a href="{{ route('unit.create') }}" class="btn btn-success btn-sm">Add new</a>
            </div>
            <div class="card-body">
                <br>
                        ...
                        <tbody>
                            @foreach ($units as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('unit.edit', $value->id) }}"
